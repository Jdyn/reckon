...
export const DemoText: Demo = {
	...
	data: [
		<DemoUseCase name="Presets" description="There are a few presets that are preconfigured.">
			<Text>
				default preset - Cillum eu laboris in labore. Excepteur mollit tempor reprehenderit
				fugiat elit et eu consequat laborum.
			</Text>

			<DemoDivider />

			<Text preset="bold">
				bold preset - Tempor et ullamco cupidatat in officia. Nulla ea duis elit id sunt
				ipsum cillum duis deserunt nostrud ut nostrud id.
			</Text>
		...
		<DemoUseCase name="Weights" description="There's a weight prop.">
			<Text weight="light">
				light - Nulla magna incididunt excepteur est occaecat duis culpa dolore cupidatat
				enim et.
			</Text>
		...
		<DemoUseCase name="Styling" description="The component can be styled easily.">
			<Text>
				<Text style={{ color: colors.error }}>
					Consequat ullamco veniam velit mollit proident excepteur aliquip id culpa ipsum
					velit sint nostrud.
				</Text>
				{` `}
				<Text style={{ color: colors.palette.neutral100, backgroundColor: colors.error }}>
					Eiusmod occaecat laboris eu ex veniam ipsum adipisicing consectetur. Magna
					ullamco adipisicing tempor adipisicing.
				</Text>
				{` `}
				<Text
